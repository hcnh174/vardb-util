...
{	
	...
	public String getMessage()
	{
		...
		if (this.exitValue!=null)
			buffer.append("exit value: ["+this.exitValue+"]\n");
		if (CStringHelper.hasContent(this.out))
			buffer.append("output stream: "+this.out+"\n");
		if (CStringHelper.hasContent(this.err))
			buffer.append("error stream: "+this.err+"\n");
