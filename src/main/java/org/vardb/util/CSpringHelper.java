...
{	
	...
	{
		CSpringHelper.registerDataSource(context,name,params.getDriver(),params.getUrl(),
	...
	{
		CSpringHelper.registerDataSource(context,name,params.getDriver(),params.getUrl(dbname),
			params.getUsername(),params.getPassword());
	}
	...
	{
		//Properties properties=CFileHelper.getProperties(filename);
